...
//    public boolean validerDemande(@PathParam("id") int idDemande, User valideur) {
//    	
...
//    @Path("/refuse/{id}")
//    @Produces(MediaType.APPLICATION_JSON)
//    public boolean refuserDemande(@PathParam("id") int idDemande, User valideur, String motifRefus) {
//    	
//        for (Demande demande : demandes) {
//        	
//            if (demande.getId() == idDemande && demande.getStatut() == Statut.CREEE) {
...
//    @Produces(MediaType.APPLICATION_JSON)
//    public boolean assignerBenevole(@PathParam("id") int idDemande, User benevole) {
//    	
//        for (Demande demande : demandes) {
//            if (demande.getId() == idDemande && demande.getStatut() == Statut.CREEE) {
//                
...
//    }
 ...
 // Obtenir toutes les demandes
    ...
    @Path("/getone/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public Demande rechercherDemandeParId(@PathParam("id") int idDemande) {
